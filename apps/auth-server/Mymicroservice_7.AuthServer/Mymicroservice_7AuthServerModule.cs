...
using Mymicroservice_7.AuthServer.Utils;
...
public class Mymicroservice_7AuthServerModule : AbpModule
{
    ...
    private void PreConfigureOpenIddict(IConfiguration configuration, IWebHostEnvironment hostingEnvironment)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "b4fcceac-8191-41cd-8bd6-153a070ca515");
