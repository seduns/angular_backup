...
```
127.0.0.1 mymicroservice_7-local-web
127.0.0.1 mymicroservice_7-local-webgateway
127.0.0.1 mymicroservice_7-local-authserver
```
...
Now, you can browse the URL: `https://mymicroservice_7-local-web`
