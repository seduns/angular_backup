...
using Mymicroservice_7.MicroserviceName.Tests.MongoDB;
{{~ end~}}

namespace Mymicroservice_7.MicroserviceName.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.MicroserviceName project,
 * but it does not have a module dependency to the Mymicroservice_7MicroserviceNameModule module class.
 * Because, Mymicroservice_7MicroserviceNameModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7MicroserviceNameModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7MicroserviceNameModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7MicroserviceNameModule))]
