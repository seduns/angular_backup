...
namespace Mymicroservice_7.IdentityService;
...
[DependsOn(
    ...
    typeof(Mymicroservice_7IdentityServiceContractsModule),
...
public class Mymicroservice_7IdentityServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7IdentityServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7IdentityServiceModule).Assembly, opts =>
                {
