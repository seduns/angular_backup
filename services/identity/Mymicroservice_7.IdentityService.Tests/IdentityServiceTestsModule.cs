...
using Mymicroservice_7.IdentityService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.IdentityService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.IdentityService project,
 * but it does not have a module dependency to the Mymicroservice_7IdentityServiceModule module class.
 * Because, Mymicroservice_7IdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7IdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7IdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7IdentityServiceModule))]
