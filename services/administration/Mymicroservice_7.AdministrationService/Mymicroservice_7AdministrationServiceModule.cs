...
namespace Mymicroservice_7.AdministrationService;
...
[DependsOn(
    ...
    typeof(Mymicroservice_7AdministrationServiceContractsModule),
...
public class Mymicroservice_7AdministrationServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7AdministrationServiceModule>();
        });
    }
        ...
        Configure<AbpDbContextOptions>(options =>
        {
            ...
            options.Configure<BlobStoringDbContext>(c =>
            {
                c.UseSqlServer(b =>
                {
                    ...
                    b.MigrationsAssembly(typeof(Mymicroservice_7AdministrationServiceModule).Assembly.GetName().Name);
                });
            });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7AdministrationServiceModule).Assembly, opts =>
                {
