...
using Mymicroservice_7.AdministrationService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.AdministrationService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.AdministrationService project,
 * but it does not have a module dependency to the Mymicroservice_7AdministrationServiceModule module class.
 * Because, Mymicroservice_7AdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7AdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7AdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7AdministrationServiceModule))]
