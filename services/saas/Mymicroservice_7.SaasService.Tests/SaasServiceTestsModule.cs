...
using Mymicroservice_7.SaasService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.SaasService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.SaasService project,
 * but it does not have a module dependency to the Mymicroservice_7SaasServiceModule module class.
 * Because, Mymicroservice_7SaasServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7SaasServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7SaasServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7SaasServiceModule))]
