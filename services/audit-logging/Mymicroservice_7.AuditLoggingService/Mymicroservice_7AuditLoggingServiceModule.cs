...
[DependsOn(
    typeof(Mymicroservice_7AuditLoggingServiceContractsModule),
...
public class Mymicroservice_7AuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7AuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<Mymicroservice_7AuditLoggingServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7AuditLoggingServiceModule).Assembly, opts =>
                {
