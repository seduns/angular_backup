...
using Mymicroservice_7.AuditLoggingService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.AuditLoggingService project,
 * but it does not have a module dependency to the Mymicroservice_7AuditLoggingServiceModule module class.
 * Because, Mymicroservice_7AuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7AuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7AuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7AuditLoggingServiceModule))]
