...
using Mymicroservice_7.ChatService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.ChatService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.ChatService project,
 * but it does not have a module dependency to the Mymicroservice_7ChatServiceModule module class.
 * Because, Mymicroservice_7ChatServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7ChatServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7ChatServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7ChatServiceModule))]
