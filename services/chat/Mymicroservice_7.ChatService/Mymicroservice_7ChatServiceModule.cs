...
[DependsOn(
    ...
    typeof(Mymicroservice_7ChatServiceContractsModule),
...
public class Mymicroservice_7ChatServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7ChatServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<Mymicroservice_7ChatServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7ChatServiceModule).Assembly, opts =>
                {
