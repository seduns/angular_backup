...
namespace Mymicroservice_7.GdprService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.GdprService project,
 * but it does not have a module dependency to the Mymicroservice_7GdprServiceModule module class.
 * Because, Mymicroservice_7GdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7GdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7GdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7GdprServiceModule))]
