...
[DependsOn(
    ...
    typeof(Mymicroservice_7GdprServiceContractsModule),
...
public class Mymicroservice_7GdprServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7GdprServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<Mymicroservice_7GdprServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7GdprServiceModule).Assembly, opts =>
                {
