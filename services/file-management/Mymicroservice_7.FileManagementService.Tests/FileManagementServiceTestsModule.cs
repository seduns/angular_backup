...
using Mymicroservice_7.FileManagementService.Data;
using Volo.Abp;
...
namespace Mymicroservice_7.FileManagementService.Tests;

/* This project has a dotnet project reference to the Mymicroservice_7.FileManagementService project,
 * but it does not have a module dependency to the Mymicroservice_7FileManagementServiceModule module class.
 * Because, Mymicroservice_7FileManagementServiceModule has configurations proper for development and production
 ...
 *
 * For example, Mymicroservice_7FileManagementServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change Mymicroservice_7FileManagementServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(Mymicroservice_7FileManagementServiceModule))]
