...
[DependsOn(
    ...
    typeof(Mymicroservice_7FileManagementServiceContractsModule),
...
public class Mymicroservice_7FileManagementServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<Mymicroservice_7FileManagementServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<Mymicroservice_7FileManagementServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(Mymicroservice_7FileManagementServiceModule).Assembly, opts =>
                {
